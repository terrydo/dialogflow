...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<?php if ( $tabs ): ?>
		<div class="col-2 col-register-text">
			...
			<a href="#" class="btn btn-color-black basel-switch-to-register" data-login="<?php _e( 'Login', 'basel') ?>" data-register="<?php _e( 'Register', 'basel') ?>"><?php echo esc_html( $button_text ); ?></a>
		</div>
	<?php endif ?>
