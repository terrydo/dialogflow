...
if( ! function_exists( 'basel_wc_attribute_update' ) ) {
	...
	function basel_wc_attribute_update( $attribute_id, $attribute, $old_attribute_name ) {
		...
		update_option( 'basel_pa_' . $attribute['attribute_name'] . '_show_on_product', sanitize_text_field( $_POST['attribute_show_on_product'] ) );
...
if( ! function_exists( 'basel_wc_attribute_add' ) ) {
	...
	function basel_wc_attribute_add( $attribute_id, $attribute ) {
		...
		add_option( 'basel_pa_' . $attribute['attribute_name'] . '_show_on_product', sanitize_text_field( $_POST['attribute_show_on_product'] ) );
	}
}
