...
if ( ! function_exists( 'basel_core_outdated_message' ) ) {
	function basel_core_outdated_message() {
		if ( class_exists( 'BASEL_Post_Types' ) && is_user_logged_in() ) {
			$core_version = get_plugin_data( ABSPATH . 'wp-content/plugins/basel-post-types/basel-post-types.php' )['Version'];

			if ( version_compare( $core_version, BASEL_POST_TYPE_VERSION, '<' ) ) {
